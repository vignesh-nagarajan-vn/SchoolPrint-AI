...
This repo is the SchoolPulse AI project, the umbrella for the SchoolPulse concept built for USAII Global AI Hackathon 2026, High School Challenge 2, Direction B: My School's Hidden Footprint.
